...
1. 配置谷歌学术引用爬虫：
    ...
    1. 在github本仓库页面的`Settings -> Secrets and variables -> Actions -> New repository secret`中，添加`GOOGLE_SCHOLAR_ID`变量，Name栏填写：`GOOGLE_SCHOLAR_ID`、Secret栏填写你的：`SCHOLAR_ID`。
